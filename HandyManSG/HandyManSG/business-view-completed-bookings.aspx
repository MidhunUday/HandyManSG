<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business-view-completed-bookings.aspx.cs" Inherits="HandyManSG.business_view_completed_bookings" %>
...
<head runat="server">
    <title></title>
    <link rel="stylesheet" type="text/css" href="business-view-completed-bookings.css" />
...
<body>
    <form id="form1" runat="server">
        ...
        <li style="width:220px;"><a href="business-view-completed-bookings.aspx" style="color:#4169E1;"><img src="Images/calendar.png" width="50" height="50"/><br />Completed Bookings</a></li>
        </ul>
<br />
            
        <div class="tablesection">
            <asp:GridView ID="gridViewCompletedBookings" runat="server"
 ...
 HeaderStyle-CssClass="bookingheader" RowStyle-CssClass="bookingrows" AllowPaging = "True"  OnPageIndexChanging = "OnPageIndexChanging"  PageSize="5"  AutoGenerateColumns="False" CellPadding="8" ShowHeaderWhenEmpty="True">
                <Columns>
                    ...
                    <asp:BoundField DataField ="bookingPrice" HeaderText="Booking Price" >
                    <HeaderStyle Width="12%" />
                    </asp:BoundField>
          ...
          forecolor="black" Font-Size="Large" Font-Italic="true" Height="50px"/> 
                <EmptyDataTemplate>No Completed Bookings</EmptyDataTemplate>
