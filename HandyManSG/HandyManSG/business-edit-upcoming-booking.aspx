<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business-edit-upcoming-booking.aspx.cs" Inherits="HandyManSG.business_edit_upcoming_booking" %>
...
<br />
       <div class="viewbookingtable">
           <table class="auto-style1">
               <tr>
                   <td class="tableheader" colspan="3">Upcoming Booking</td>
               </tr>
               ...
               <tr>
                   <td class="textboxtoadjust">
                       <asp:TextBox ID="txtBookingFinalPrice" runat="server" Width="320px" disabled="disabled"></asp:TextBox>
                   </td>
                   <td class="statusbar">
