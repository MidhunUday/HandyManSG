<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer-view-completed-bookings.aspx.cs" Inherits="HandyManSG.customer_view_completed_bookings" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="customer-view-completed-bookings.css"/>
    ...
    <form id="form1" runat="server">
        ...
        <main>
            <ul class="main-list">
                ...
                <li class="main-item btn-primary"><a href="customer-view-completed-bookings.aspx">Completed Bookings</a></li>
            </ul>
            <asp:GridView ID="gridViewCompletedBookings" runat="server" AutoGenerateColumns="False" OnPageIndexChanging = "OnPageIndexChanging" BorderStyle="None" AllowPaging="True" PageSize="3" style="margin-left: 100px" >
                <Columns>
                    <asp:TemplateField HeaderStyle-BorderStyle="None" ItemStyle-BorderStyle="None" ItemStyle-Height="300">
                        <ItemTemplate>
                            <div class="container">
                                    <div class="card">
                                        <div class="left-card">
                                            <div class="card-item">Title: <asp:Label ID="lblserviceTitle" runat="server" Text='<%# Eval("serviceTitle") %>' Font-Size="Larger" Font-Bold="True"></asp:Label></div>
                                            ...
                                            <div class="card-item"><i class="fa-solid fa-dollar-sign"></i> Booking Price: <asp:Label ID="lblbookingPrice" runat="server" Text='<%# Eval("bookingPrice") %>'></asp:Label></div>
                                        </div>
                                        <div class="center-card">
                                            <div class="jobdetails"><asp:Label ID="lblserviceDesc" runat="server" Text='<%# Eval("serviceDesc") %>'></asp:Label></div>
                                        </div>
