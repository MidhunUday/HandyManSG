<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business-edit-services.aspx.cs" Inherits="HandyManSG.business_edit_services" %>
...
<head runat="server">
    <title></title>
    <link rel="stylesheet" type="text/css" href="business-edit-services.css" />
           ...
           <table class="auto-style1">
               ...
               <tr>
                   <td class="textboxtoadjust2">
                       <asp:TextBox ID="txtServiceID" runat="server" CssClass="auto-style24" Width="320px" disabled="disabled"></asp:TextBox>
                   </td>
                   <td class="textboxtoadjust2">
                       <asp:TextBox ID="txtServiceTitle" runat="server" Width="320px" ></asp:TextBox>
                   </td>
               ...
               <tr>
                   ...
                   <td class="tdcancelandupdatebutton2">
                       <asp:LinkButton CssClass="cancelbutton2" ID="btnCancel" runat="server" OnClick="btnCancel_Click">Cancel</asp:LinkButton>
&nbsp;&nbsp;&nbsp;
                       <asp:LinkButton CssClass="updatebutton2" ID="btnUpdateBooking" runat="server" OnClick="btnUpdateBooking_Click">Update Booking</asp:LinkButton>
                   </td>
               </tr>
           </table>
           </div>
