<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="business-view-new-bookings.aspx.cs" Inherits="HandyManSG.business_view_new_bookings" %>
...
<head runat="server">
    <title></title>
    <link rel="stylesheet" type="text/css" href="business-view-new-bookings.css" />
...
<body>
    <form id="form1" runat="server">
        ...
        <li style="width:220px;"><a href="business-view-new-bookings.aspx" style="color:#4169E1;"><img src="Images/booking.png" width="50" height="50"/><br />New Bookings</a></li>
...
<br />
        ...
        <div class="tablesection">
            <asp:GridView ID="gridViewNewBookings" runat="server"
                CssClass="mybookingdatagrid" PagerStyle-CssClass="bookingpager"
 HeaderStyle-CssClass="bookingheader" RowStyle-CssClass="bookingrows" AllowPaging = "True"  AutoGenerateColumns="False" OnPageIndexChanging = "OnPageIndexChanging"  PageSize="5"  CellPadding="8" ShowHeaderWhenEmpty="True">
                <Columns>
                    ...
                    <asp:BoundField DataField ="Booking_Creation_Time" HeaderText="Booking Creation Time" >
